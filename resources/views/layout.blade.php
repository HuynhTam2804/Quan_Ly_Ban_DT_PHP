...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" 
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('sanpham.danh-sach') }}">Sản Phẩm</a>
                        <a class="collapse-item" href="{{ route('loaisanpham.danh-sach') }}">Loại Sản Phẩm</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('nhacungcap.danh-sach') }}">Danh Sách</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" 
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('hoadonnhap.danh-sach') }}">Phiếu Nhập</a>
                        <a class="collapse-item" href="{{ route('hoadonxuat.danh-sach') }}">Phiếu Xuất</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseChart" class="collapse" aria-labelledby="headingChart" 
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('khachhang.danh-sach') }}">Khách Hàng</a>
                        <a class="collapse-item" href="{{ route('quantrivien.danh-sach') }}">Quản Trị Viên</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter">28</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                ...
                                <!-- Counter - Messages -->
                                <span class="badge badge-danger badge-counter">04</span>
                            </a>
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; My Website 2003 - 2023</span>
                    </div>
                </div>
            </footer>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Nhấn "Logout" để đăng xuất hoắc "Cancel" để hủy.</div>
    ...
    <script src="{{ asset('bootstrap-5.2.3/jquery-3.7.1.min.js')}}"></script>
